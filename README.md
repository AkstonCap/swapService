...
| [`docs/POST_CHANGE_REVIEW_2026-09-07.md`](docs/POST_CHANGE_REVIEW_2026-09-07.md) | **Current safety repair** | Exact-source disposition, atomic fees and fail-closed recovery; local verification and remaining live release gates. |
| [`docs/DEVELOPMENT_REVIEW_2026-09-07.md`](docs/DEVELOPMENT_REVIEW_2026-09-07.md) | Baseline independent review | Reproduced defects at `6568446`; historical evidence for the current repair. |
